...
export default function BesoinAvocat() {
    return (
        <div className={"relative"}>
            ...
            <Image loading={"eager"} className={"brightness-50 h-[400px] w-full object-cover"} src={"/images/BesoinAvocat/besoin-avocat-banniere.png"} alt={"image-banniere-besoin-avocat"} width={"600"} height={"600"}></Image>
        </div>
    );
}
