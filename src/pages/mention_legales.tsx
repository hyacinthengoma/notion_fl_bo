        ...
        <>
            ...
            <div className={"w-full flex justify-center bg-white py-20"}>
                <div className={"w-5/6 text-justify"}>
                    ...
                    <p className={"font-regular text-gray-700 text-lg mb-6"}>Ce site est hébergé par</p>
                    <p className={"font-regular text-gray-700 text-lg mb-6"}>Site web développé par : </p>
                    ...
                    <p className={"font-regular text-gray-700 text-lg mb-6"}>Ce site utilise Google Analytics, un service d’analyse de site internet fourni par Google Inc. (« Google »). Google Analytics utilise des cookies (fichiers de petite taille, qui ne permettent pas l’identification de l’utilisateur, mais qui enregistrent des informations relatives à la navigation d’un ordinateur sur un site) pour aider le site internet à analyser l’utilisation du site par ses utilisateurs. Les données générées par les cookies concernant votre utilisation du site (y compris votre adresse IP) seront transmises et stockées par Google sur des serveurs situés aux Etats-Unis. Google utilisera cette information dans le but d’évaluer votre utilisation du site, de compiler des rapports sur l’activité du site à destination de son éditeur et de fournir d’autres services relatifs à l’activité du site et à l’utilisation d’Internet. Google est susceptible de communiquer ces données à des tiers en cas d’obligation légale ou lorsque ces tiers traitent ces données pour le compte de Google, y compris notamment l’éditeur de ce site. Google ne recoupera pas votre adresse IP avec toute autre donnée détenue par Google. Vous pouvez désactiver l’utilisation de cookies en sélectionnant les paramètres appropriés de votre navigateur*. Cependant, une telle désactivation pourrait empêcher l’utilisation de certaines fonctionnalités de ce site. En utilisant ce site internet, vous consentez expressément au traitement de vos données nominatives par Google dans les conditions et pour les finalités décrites ci-dessus.
                        ...
                        *Sous Internet Explorer : onglet outil / options internet. Cliquez sur Confidentialité et choisissez Bloquer tous les cookies. Validez sur Ok.
                        ...
                        Sous Firefox : onglet Outils > Options. Sélectionnez l’onglet Vie privée. Décochez Accepter les cookies. Validez sur Ok.
                        ...
                        Votre consentement s’applique aux domaines suivants : avocat-babeau.fr

                        Votre état ​​actuel: Autoriser tous les cookies (Nécessaires, Préférences, Statistiques, Marketing).

                        Modifiez votre consentement  |  Retirez votre consentement

                        Déclaration relative aux cookies mise à jour le 23/11/2018 par Cookiebot:

                        ## AJOUTER ELEMENT COOKIEBOT DANS BACK OFFICE POUR AFFICHER LE TABLEAU DES COOKIES ##</p>
                </div>
            </div>
