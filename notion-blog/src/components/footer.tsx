...
export default function Footer() {
  return (
    <>
        ...
        <footer aria-label="Site Footer" className={"bg-red-900"}>
                    ...
                    >
                        ...
                        <div className={"col-span-2 lg:col-span-3 lg:flex lg:items-end"}>
                            <form className={"w-full"}>
                                ...
                                <div
                                    className={"p-2 border border-gray-100 focus-within:ring dark:border-gray-800 sm:flex sm:items-center sm:gap-4"}
                                >
                                    <input
                                        type="email"
                                        id="UserEmail"
