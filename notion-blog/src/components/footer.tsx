  ...
  return (
    <>
      <footer className="bg-red-700">
        <div className="flex m-5 md:flex-row flex-col m-auto">
          ...
          <div className="md:ml-auto flex flex-col m-auto">
            ...
            <div className="flex flex-row gap-5">
              ...
              <button className="btn btn-active btn-accent">S'abonner a ma newsletter</button>
            </div>
